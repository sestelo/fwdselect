...
#'  instant, in  μg/m3N. This is the value that we want to predict.}
#'  \item{In0}{registered values of SO2 at a specific temporal instant, in this
#'  case instant zero, in  μg/m3N.} \item{In1}{registered values of SO2 at a
#'  specific temporal instant, in this case 5-min instant temporal before, in
#'  μg/m3N.} \item{In2}{registered values of SO2 at a specific temporal instant,
#'  in this case 10-min instant temporal before, in μg/m3N.} ... }
#' @examples
#' data(episode)
#' head(episode)
#'
